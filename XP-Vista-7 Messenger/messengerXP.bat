...
echo.
echo.---------------------------------------------
echo Kaleb's Batch Messenger Client for Windows XP
...
if "%begin%"=="msgStart" goto msgStart
...
echo msgStart = Starts the XP messaging service
...
echo.
echo To use message, you must activate the service first using msgStart
echo.
echo Press enter to return
pause >NUL
goto title
...
net send %n% %m%
echo.
set /p yn=Would you like to save this message in text format?
if "%yn%"=="yes" goto genMSG
if "%yn%"=="no" echo.
echo Press enter to return
pause >NUL
goto title
...
net start messenger
echo. 
echo Complete, press enter to return
pause >NUL
goto title
